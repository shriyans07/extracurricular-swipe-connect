...
const sampleActivities = [
    {
        ...
        roles: 'Treasurer (11)',
        description:
            'Managed $2k+ in club assets; Hosted 10+ fundraisers, stimulating local businesses and growing club fund by 165%.',
    },
    {
        id: '2',
        ...
        description:
            'Started on Varsity all 4 years; Won CIF State Division 2A in 10th & 11th grade; Named in All-County team in 11th grade.',
    },
    {
        id: '3',
...
const TrackActivities = () => {
    ...
    const [sortBy, setSortBy] = useState('career-field');
    ...
    return (
        <div className="min-h-screen" style={{ backgroundColor: '#f5f7fa' }}>
            ...
            <div className="max-w-6xl mx-auto p-6">
                {/* Header */}
                <div className="mb-8">
                    <h1 className="text-4xl font-poppins font-black mb-4 text-black">Track Activities</h1>
                    ...
                    <div className="flex flex-col md:flex-row gap-4 mb-6">
                        <Input
                            ...
                            className="flex-1 font-poppins bg-white text-black
                        ...
                        <Select value={sortBy} onValueChange={setSortBy}>
                            <SelectTrigger
                                className="w-full md:w-48 font-poppins bg-white text-black
                           focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-offset-0
                           focus-visible:ring-[var(--accent,_#5b55f7)] focus-visible:border-[var(--accent,_#5b55f7)]"
                                style={{ ['--accent' as any]: ACCENT }}
                            >
                ...
                <div className="grid gap-6">
                    {filteredAndSortedActivities.map((activity) => (
                        ...
                        >
                            {/* Tighten spacing between header and content */}
                        ...
                        {activity.grades.join(', ')}
                                        ...
                                        <p className="text-gray-600 font-poppins font-semibold mb-2">{activity.roles}</p>
                                        {/* Removed mb-3 to reduce space */}
                                        <div className="flex gap-4 text-sm font-poppins font-medium text-gray-600">
                                    ...
                                    <div className="flex gap-2" onClick={(e) => e.stopPropagation()}>
                                        ...
                                        <Button variant="outline" size="sm" style={{ color: ACCENT }}>
                            ...
                            <CardContent className="pt-2">
                                <p className="text-gray-700 font-poppins font-normal text-sm">{activity.description}</p>
                            </CardContent>
                        </Card>
                    ))}
                </div>
                    ...
                    <DialogContent className="max-w-lg" style={{ backgroundColor: '#f5f7fa' }}>
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <Input
                                    placeholder="Roles"
                                    defaultValue={selectedActivity?.roles}
                                    className="font-poppins bg-white text-black
                             focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-offset-0
                             focus-visible:ring-[var(--accent,_#5b55f7)] focus-visible:border-[var(--accent,_#5b55f7)]"
                                    style={{ ['--accent' as any]: ACCENT }}
                                ...
                                <div className="grid grid-cols-4 gap-2">
                                    {['Pre-9', '9', '10', '11', '12', 'Post-12'].map((grade) => (
                                        <div key={grade} className="flex items-center space-x-2">
                                            <Checkbox id={`grade-${grade}`} defaultChecked={selectedActivity?.grades?.includes(grade)} />
                                            <label
                                                htmlFor={`grade-${grade}`}
                                                className="text-sm font-poppins font-medium text-black"
                                            >
                                                {grade}
                                            </label>
                                        </div>
                            ...
                            <div className="flex gap-2">
                                <div className="flex-1">
                                    ...
                                    <Input
                                        ...
                                        type="number"
                                        defaultValue={selectedActivity?.hoursPerWeek}
                                        className="font-poppins bg-white text-black
                               focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-offset-0
                               focus-visible:ring-[var(--accent,_#5b55f7)] focus-visible:border-[var(--accent,_#5b55f7)]"
                                        style={{ ['--accent' as any]: ACCENT }}
                                ...
                                <div className="flex-1">
                                    ...
                                    <Input
                                        ...
                                        type="number"
                                        defaultValue={selectedActivity?.weeksPerYear}
                                        className="font-poppins bg-white text-black
                               focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-offset-0
                               focus-visible:ring-[var(--accent,_#5b55f7)] focus-visible:border-[var(--accent,_#5b55f7)]"
                                        style={{ ['--accent' as any]: ACCENT }}
